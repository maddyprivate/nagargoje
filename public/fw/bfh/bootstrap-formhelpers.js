...
'India':{
    '1' : {'code':'Andaman and Nicobar Islands','name':'Andaman and Nicobar Islands'},
    '2' : {'code':'Andhra Pradesh','name':'Andhra Pradesh'},
    '3' : {'code':'Arunachal Pradesh','name':'Arunachal Pradesh'},
    '4' : {'code':'Assam','name':'Assam'},
    '5' : {'code':'Bihar','name':'Bihar'},
    '6' : {'code':'Chandigarh','name':'Chandigarh'},
    '7' : {'code':'Chhattisgarh','name':'Chhattisgarh'},
    '8' : {'code':'Dadar and Nagar Haveli','name':'Dadar and Nagar Haveli'},
    '9' : {'code':'Daman and Diu','name':'Daman and Diu'},
    '10' : {'code':'Delhi','name':'Delhi'},
    '11' : {'code':'Goa','name':'Goa'},
    '12' : {'code':'Gujarat','name':'Gujarat'},
    '13' : {'code':'Haryana','name':'Haryana'},
    '14' : {'code':'Himachal Pradesh','name':'Himachal Pradesh'},
    '15' : {'code':'Jammu and Kashmir','name':'Jammu and Kashmir'},
    '16' : {'code':'Jharkhand','name':'Jharkhand'},
    '17' : {'code':'Karnataka','name':'Karnataka'},
    '18' : {'code':'Kerala','name':'Kerala'},
    '19' : {'code':'Lakshadweep','name':'Lakshadweep'},
    '20' : {'code':'Madhya Pradesh','name':'Madhya Pradesh'},
    '21' : {'code':'Maharashtra','name':'Maharashtra'},
    '22' : {'code':'Manipur','name':'Manipur'},
    '23' : {'code':'Meghalaya','name':'Meghalaya'},
    '24' : {'code':'Mizoram','name':'Mizoram'},
    '25' : {'code':'Nagaland','name':'Nagaland'},
    '26' : {'code':'Odisha','name':'Odisha'},
    '27' : {'code':'Pondicherry','name':'Pondicherry'},
    '28' : {'code':'Punjab','name':'Punjab'},
    '29' : {'code':'Rajasthan','name':'Rajasthan'},
    '30' : {'code':'Sikkim','name':'Sikkim'},
    '31' : {'code':'Tamil Nadu','name':'Tamil Nadu'},
    '32' : {'code':'Telangana','name':'Telangana'},
    '33' : {'code':'Tripura','name':'Tripura'},
    '34' : {'code':'Uttar Pradesh','name':'Uttar Pradesh'},
    '35' : {'code':'Uttarakhand','name':'Uttarakhand'},
    '36' : {'code':'West Bangal','name':'West Bangal'}  
},
  // LIst with proper gstin codes with state valuesin short form
  // 'IN':{
  //   '1' : {'code':'JK','name':'Jammu and Kashmir'},
  //   '2' : {'code':'HP','name':'Himachal Pradesh'},
  //   '3' : {'code':'PB','name':'Punjab'},
  //   '4' : {'code':'CH','name':'Chandigarh'},
  //   '5' : {'code':'UK','name':'Uttarakhand'},
  //   '6' : {'code':'HR','name':'Haryana'},
  //   '7' : {'code':'DL','name':'Delhi'},
  //   '8' : {'code':'RJ','name':'Rajasthan'},
  //   '9' : {'code':'UP','name':'Uttar Pradesh'},
  ...
  //   '25' : {'code':'DD','name':'Daman and Diu'},
  //   '26' : {'code':'DH','name':'Dadar and Nagar Haveli'},
